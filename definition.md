each dir will contain a .tags file that will contain the tags
the app will traverse the directory tree and if the tags match the tags requested the path will be added to the list.
